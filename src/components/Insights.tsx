  ...
  const insights = [
    {
      ...
      technologies: ["Red Hat Fuse", "Apache Camel", "Microservices", "Cloud-Native"],
    ...
    },
    {
      ...
      technologies: ["Camunda BPM", "Cloud-Native", "Microservices", "Process Automation"],
    ...
    },
    {
      ...
      type: "event",
      date: "March 15, 2025",
      technologies: ["Oracle BRM", "BSS/OSS", "Telecom", "Digital Transformation"],
    ...
    },
    {
      ...
      type: "article",
      readTime: "8 min read",
      technologies: ["Red Hat PAM", "jBPM", "Business Process", "Automation"],
    ...
    },
    {
      ...
      technologies: ["AI/ML", "Data Science", "MLOps", "Predictive Analytics"],
    ...
    },
    {
      ...
      type: "event",
      date: "April 20, 2025",
      technologies: ["Cloud Migration", "AWS", "Azure", "Microservices"],
